...
Verify login success with valid credentials
        ...
        Input Text    xpath://textarea[@id='ta1']    Hi this is Bhuvi        timeout=5
        Sleep    4s
        ...
        Sleep    1
        Input Text    css:div[id='HTML11'] textarea    This is Bhuvi@123
        Sleep    2
        ...
        Sleep    2s
        Input Text    xpath://form[@name='form1']//input[@type='text']    Bhuvi@123
        Sleep    2s
        Input Text    xpath://form[@name='form1']//input[@type='password']    Bhuvi@123
        Sleep    2s
        Click Element    xpath://button[normalize-space()='LogIn']


#Search the blog
         Input Text    xpath://input[@name='q']    Bhuvi@123
         Sleep    2s
...
#Simple login
        Input Text    xpath://input[@name='userid']    Bhuvi
        Sleep    1s
        Input Text    xpath://input[@name='pswrd']    Bhuvi@123
        Sleep    1s
